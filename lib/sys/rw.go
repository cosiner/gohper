...
//go:generate gotmpl -p "github.com/cosiner/gohper/lib/types" -o ./$GOFILE -f FilterV -t "T:string"
...
//go:generate gotmpl -p "github.com/cosiner/gohper/lib/types" -o ./$GOFILE -f FilterV -t "T:[]byte]"
